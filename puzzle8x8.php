...
if ($_GET['id']=='new') {
    mysql_query("INSERT INTO puzzles SET puzzle_fen='8/8/8/8/8/8/8/8', puzzle_boardsize='8x8';");
...
<head>
    ...
    <script src="js/main8x8.js" type='text/javascript'></script>
...
<body>
    ...
    <div data-role="mainview">
        ...
        <div data-role="content">
            <div id="board" style="width: 500px" class="inactive"></div>
<script>
    dw=$(window).width();
    if (dw<600) {
...
$('#goal').keyup(function(){
    ...
    <?php include 'history_journey.php'; ?><div id="history"></div>
            ...
            <div id="create-buttons" class="inactive">
                ...
                <!-- <div id="firstMove">первый ход белых</div> -->
                <div id="boardSize">доска 8х8</div>
                <div id="setStartPosition">стартовая позиция с рокировкой</div>
            </div>
