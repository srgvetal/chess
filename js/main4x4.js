...
$(document).ready(function() {
    ...
    $('#check-was').click(function() {
        if (location.href.indexOf('was') == -1) location.href = 'puzzle-check-was4x4.php?id=' + $_GET['id'] + '&user=' + $_GET['user'];
    })
    $('#check-new').click(function() {
        if (location.href.indexOf('solved') == -1) location.href = 'puzzle-check-solved4x4.php?id=' + $_GET['id'] + '&user=' + $_GET['user'];
    })
